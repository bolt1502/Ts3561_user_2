...
.method public static final T(Ljava/lang/Object;Ljava/lang/Class;Lcom/T/T/T3/TJ;)Ljava/lang/Object;
    ...
    .param p2, "mapping"    # Lcom/T/T/T3/TJ;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
            "Ljava/lang/Object;",
...
.method public static final T(Ljava/util/Map;Ljava/lang/Class;Lcom/T/T/T3/TJ;)Ljava/lang/Object;
    ...
    .line 749
    .end local v18    # "object":Lcom/T/T/Te;
    :cond_5
    ...
    .restart local v18    # "object":Lcom/T/T/Te;
    goto :goto_2
    ...
    .line 762
    .local v21, "setters":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Lcom/T/T/T3/T/T0;>;"
    const/16 v23, 0x0
    ...
    .line 769
    .local v7, "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/String;Lcom/T/T/T3/T/T0;>;"
    ...
    .line 772
    .local v9, "fieldDeser":Lcom/T/T/T3/T/T0;
    move-object/from16 v0, p0
...
.method public static T(Ljava/lang/Class;Ljava/util/Map;Z)Ljava/util/List;
    ...
    .line 886
    .local v13, "fieldInfoMap":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Lcom/T/T/TN/T2;>;"
    ...
    .line 912
    .local v4, "annotation":Lcom/T/T/T/T3;
    if-nez v4, :cond_3
    ...
    .line 972
    .local v10, "fieldAnnotation":Lcom/T/T/T/T3;
    if-eqz v10, :cond_7
    ...
    .line 990
    .end local v10    # "fieldAnnotation":Lcom/T/T/T/T3;
    :cond_7
    if-eqz p1, :cond_8
    ...
    .line 1023
    .restart local v10    # "fieldAnnotation":Lcom/T/T/T/T3;
    if-eqz v10, :cond_a
    ...
    .line 1052
    .end local v4    # "annotation":Lcom/T/T/T/T3;
    .end local v6    # "c2":C
    ...
    .line 1084
    .local v12, "fieldInfoList":Ljava/util/List;, "Ljava/util/List<Lcom/T/T/TN/T2;>;"
    const/4 v8, 0x0
    ...
    .line 1088
    .local v4, "annotation":Lcom/T/T/T/T2;
    if-eqz v4, :cond_16
    ...
    .line 1107
    .local v11, "fieldInfo":Lcom/T/T/TN/T2;
    ...
    .line 1093
    .end local v11    # "fieldInfo":Lcom/T/T/TN/T2;
    :cond_17
    add-int/lit8 v14, v14, 0x1
    ...
    .line 1111
    .restart local v11    # "fieldInfo":Lcom/T/T/TN/T2;
    invoke-interface {v12, v11}, Ljava/util/List;->add(Ljava/lang/Object;)Z
...
.method private static T(Ljava/lang/Class;Ljava/lang/String;)Z
    ...
    .line 1158
    .local v3, "jsonType":Lcom/T/T/T/T2;
    if-eqz v3, :cond_2
...
.method public static final TJ(Ljava/lang/Object;)Ljava/lang/Long;
    ...
    .line 372
    .local v1, "dateParser":Lcom/T/T/T3/Tw;
    const/4 v0, 0x0
    ...
    .end local v1    # "dateParser":Lcom/T/T/T3/Tw;
    .end local v2    # "strVal":Ljava/lang/String;
    :cond_4
